...
public class Activator extends AbstractUIPlugin {
	...
	public static final String PLUGIN_ID = "no.javatime.inplace.log"; //$NON-NLS-1$
	public static final String BUNDLE_LOGGER_NAME = "no.javatime.inplace.log.logger"; //$NON-NLS-1$
