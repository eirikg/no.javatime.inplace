...
public interface BundleRegion {
	 ...
	 * the project is activated and the associated bundle is registered as activated with the region.
	 * 
	 ...
	 * project is activated and the specified bundle is registered as activated with the region.
	 * 
