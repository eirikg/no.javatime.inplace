...
public class BundleNode {
	...
	public static String formatSymbolicKey(Bundle bundle, IProject project) {
		...
		if (null != bundle) {
			...
			String version = null;
			try {
				symbolicName = BundleWorkspaceImpl.INSTANCE.getSymbolicNameFromManifest(project);
				version = BundleWorkspaceImpl.INSTANCE.getBundleVersionFromManifest(project);
