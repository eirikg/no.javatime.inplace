...
public class EagerActivationHandler extends AbstractHandler implements IElementUpdater {

	public static String commandId = "no.javatime.inplace.command.eageractivation";
	public static String stateId = "no.javatime.inplace.command.eageractivation.toggleState";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		cmdStore.setIsEagerOnActivate(stateVal);
		try {
			cmdStore.flush();
	...
	public void updateElement(UIElement element, @SuppressWarnings("rawtypes") Map parameters) {
		CommandOptions cmdStore = Activator.getDefault().getPrefService();
		element.setChecked(cmdStore.isEagerOnActivate());
	}
	...
	public boolean isEnabled() {
		...
		if (null != service) {
			...
			Boolean stateVal = (Boolean) state.getValue();
			Boolean storeVal = cmdStore.isEagerOnActivate();
